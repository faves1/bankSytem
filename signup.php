...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <!-- Title  -->
    <title>Trinex Investment Bank</title>
                            ...
                            <form action="includes\signup.inc.php" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-4">
                                        ...
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" class="form-control" name="email" placeholder="Enter your Email Adress" required>
                                        </div>
                                    ...
                                    <div class="col-12 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="tel" id="phone" class="form-control intl-tel-input" name="num" placeholder="Enter your Phone Number" required>
                                        </div>
                                    ...
                                    <div class="col-12 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="acct" required>
                                             <option slected value="">select account type</option>
                                    ...
                                    <div class="col-12 mb-4">
                                     ...
                                     <div class="col-12 mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" name="rpassword" placeholder="Re-enter your password" required>
                                        </div>
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-12 center">
                                        <button type="submit" name="submit" class="btn btn-primary d-block w-100 mt-4 mb-0">Register</button>
                                    </div>
                                </div>
...
<script>
    var input = document.querySelector("#phone");
        ...
        // Get the selected country code when the form is submitted
        var form = document.querySelector("form");
        form.addEventListener("submit", function(event) {
            // Set the country code input field value before form submission
